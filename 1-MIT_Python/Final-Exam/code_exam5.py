...
class edx(object):
    ...
    def setGrade(self, grade, course="6.01x"):
        ...
        for student in self.myCourses:
            if student.courseName == course:
    ...
    def getGrade(self, course="6.02x"):
        ...
        for student in self.myCourses:
            if student.courseName == course: return student.getGrade()
        return -1
