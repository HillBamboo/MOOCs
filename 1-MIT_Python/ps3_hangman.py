...
def getGuessedWord(secretWord, lettersGuessed):
    ...
    aStr = ''
    for i in secretWord:
        if i not in lettersGuessed: aStr += '_ '
        else: aStr += i
    return aStr
...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    print "-----------"        
    if isWordGuessed(secretWord, lettersGuessed): print "Congratulations, you won!"
